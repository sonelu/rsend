...
def test_code(test_case):
    ...
    # we are only interesed in the position of the EE so we'll not do the GripperCorrection

    your_wc = wc            # <--- Load your calculated WC values in this array
    your_ee = Tforw[0:3,3]  # <--- Load your calculated end effector value from your forward kinematics
    ########################################################################################
